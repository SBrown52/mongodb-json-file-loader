package com.sbrown52.jsonimport;

import java.io.File;
import java.util.List;

import com.sbrown52.jsonimport.service.ImportJsonService;
import com.sbrown52.jsonimport.service.ImportUtils;
...
public class Application implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        if (args.containsOption("import")) {
            ...
            log.error("Must specify file to import");
            System.exit(0);
        }
    }
}